    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full space-y-16">
        ...
        <div className="flex flex-col items-start space-y-4">
          ...
          <p className="flex items-center gap-4 text-xs md:text-sm font-mono tracking-[0.2em] text-white/50">
            <span className="w-10 h-px bg-red-600" aria-hidden="true"></span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">MY JOURNEY & WHO I AM</h3>
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I’m <span className="text-white font-bold drop-shadow">Pudi Naveen</span>, a Performance Marketer and Growth Manager with 5+ years of experience in digital marketing, user acquisition and product growth.
              </p>
            ...
            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Performance Marketing</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Product Growth</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Growth Strategy</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">WHAT I’VE BUILT & DELIVERED</h3>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">MY GROWTH TOOLKIT</h3>
              <p className="text-base md:text-lg font-semibold text-white">Platforms, analytics and AI tools I use to plan, execute and scale growth.</p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Google Ads', 'Meta Ads', 'GA4', 'MMP', 'Google Sheets', 'Apps Script', 'n8n', 'Claude', 'ChatGPT', 'Looker Studio', 'Figma', 'Notion'].map((tech, idx) => (
                <span
                  key={idx}
                  className="px-4 py-2 rounded bg-white/[0.04] border border-white/10 text-xs font-mono tracking-wider text-white shadow-inner hover:bg-red-600/20 hover:border-red-600/40 hover:scale-105 transition-all"
                >
                  {tech}
                </span>
              ))}
